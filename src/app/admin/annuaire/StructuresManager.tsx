...
import { addStructure, deleteStructure, updateStructure, addActivite, deleteActivite, validateStructure } from './actions'
                    ...
                    <div className="flex items-center justify-end gap-2">
                      {s.enAttenteMaj && (
                        <button type="button" onClick={async () => {
                          await validateStructure(s.id)
                          window.location.reload()
                        }} className="text-emerald-500 hover:text-emerald-700 p-2 hover:bg-emerald-50 rounded transition-colors" title="Valider">
