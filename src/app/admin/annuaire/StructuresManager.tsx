          ...
          <form onSubmit={handleAdd} className="space-y-4">
                ...
                <div className="absolute z-20 top-full left-0 right-0 mt-1 bg-white border border-slate-200 shadow-xl rounded-lg overflow-hidden flex flex-col">
                      ...
                      return (
                        <div key={act} className="flex items-center justify-between hover:bg-slate-50 p-2 rounded">
                          ...
                          <form action={async () => {
                            ...
                            <button type="submit" className="text-slate-400 hover:text-red-600 p-1 rounded" title="Supprimer du menu">
                  ...
                  <div className="border-t border-slate-200 p-2 bg-slate-50 flex gap-2">
                    ...
                    <form action={async () => {
                      ...
                      <button type="submit" className="bg-blue-600 hover:bg-blue-700 text-white p-1.5 rounded" title="Ajouter l'activité">
            ...
            <div className="grid grid-cols-1 gap-4">
              <div>
                ...
                <input type="text" value={formData.public} onChange={e => setFormData({...formData, public: e.target.value})} className="w-full px-3 py-2 border border-slate-300 rounded-lg text-sm" />
              </div>
            </div>
            ...
            <div>
              ...
              <input type="url" value={formData.site} onChange={e => setFormData({...formData, site: e.target.value})} className="w-full px-3 py-2 border border-slate-300 rounded-lg text-sm" />
            </div>
            <div>
              ...
              <tbody className="divide-y divide-slate-100">
                ...
                <tr key={s.id} className="hover:bg-slate-50">
                  <td className="px-4 py-3">
                    <div className="font-semibold text-slate-900 text-base">{s.nom}</div>
