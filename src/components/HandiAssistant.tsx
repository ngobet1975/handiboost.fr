...
export default function HandiAssistant() {
  ...
  return (
    <>
      ...
      <div style={{ background: C.bg, borderRadius: 28, overflow: 'hidden', display: 'flex', flexDirection: 'column', height: 'min(75vh, 750px)', minHeight: 450, position: 'relative', fontSize: FS }}>
